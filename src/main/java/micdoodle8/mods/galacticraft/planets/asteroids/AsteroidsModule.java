...
public class AsteroidsModule implements IPlanetsModule
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        FluidContainerRegistry.registerFluidContainer(new FluidContainerData(new FluidStack(AsteroidsModule.fluidLiquidOxygen, 8000), new ItemStack(AsteroidsItems.canisterLOX2, 1, 1), new ItemStack(AsteroidsItems.canisterLOX2, 1, 8001)));
        FluidContainerRegistry.registerFluidContainer(new FluidContainerData(new FluidStack(AsteroidsModule.fluidLiquidOxygen, 32000), new ItemStack(AsteroidsItems.canisterLOX3, 1, 1), new ItemStack(AsteroidsItems.canisterLOX3, 1, 32001)));
        FluidContainerRegistry.registerFluidContainer(new FluidContainerData(new FluidStack(GalacticraftCore.fluidFuel, 8000), new ItemStack(AsteroidsItems.canisterOIL2, 1, 1), new ItemStack(AsteroidsItems.canisterLOX2, 1, 8001)));
        FluidContainerRegistry.registerFluidContainer(new FluidContainerData(new FluidStack(GalacticraftCore.fluidFuel, 32000), new ItemStack(AsteroidsItems.canisterOIL3, 1, 1), new ItemStack(AsteroidsItems.canisterLOX3, 1, 32001)));
    }
