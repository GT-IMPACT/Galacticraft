...
public class ItemCanisterOil2 extends ItemCanisterTierEmpty {
    ...
    public static void saveDamage(ItemStack itemstack, int damage) {
        ItemCanisterOil2.craftingvalues.put(itemstack, Integer.valueOf(damage));
    }
    ...
    public ItemStack getContainerItem(ItemStack itemstack) {
        Integer saved = ItemCanisterOil2.craftingvalues.get(itemstack);
        if (saved != null) {
            if (saved < this.mPreCapacity + 1) {
                ItemCanisterOil2.craftingvalues.remove(itemstack);
