...
public class ItemRendererTier2Rocket implements IItemRenderer {
    ...
    public ItemRendererTier2Rocket(IModelCustom model, String texture) {
        this.modelSpaceship = model;
        this.texture = new ResourceLocation(MarsModule.ASSET_PREFIX, "textures/model/" + texture + ".png");
    }
